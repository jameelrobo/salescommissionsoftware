...
export default function Analytics(props) {
  ...
  const [isYearMonthsEnableDisable, setIsYearMonthsEnableDisable] = useState(false);
    ...
    axios
      ...
      .then((res) => {
        ...
        const objdatagrid = {
          ...
          MonthName:   '',
          InvoiceNo:  '',
          TotalSalesAmt: (Number(TotalAmt).toFixed(2)) ,
          GrossCommRate: '',
          GrossCommAmt:  (Number(TotalCommAmt).toFixed(2)),
          SalesmanCommRate: '',
          SalesmanCommAmt: (Number(TotalSalesCommAmt).toFixed(2)),
          CreatedBy: 1,
          IsActive: 1,
        };
        debugger;
